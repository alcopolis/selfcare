...
//		echo $this->db->last_query();
		...
		$this->table->set_heading('No', 'Tanggal Tagihan','Jumlah Tagihan','Lihat','Simpan');
		...
		foreach ($bill_summs as $bill)
			...
			$this->table->add_row(++$i,
					...
					$bill->AMOUNT,
					anchor('billing/view_billing/'.$bill->HISTORYID,"Buka",array('class' => 'btn billing')),
					anchor('billing/pdf_billing/'.$bill->HISTORYID,"PDF",array('class' => 'btn billing'))
...
function view_billing($historyid){
		//$this->load->helper(array('dompdf', 'file'));
