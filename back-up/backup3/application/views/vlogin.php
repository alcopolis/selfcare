<div id="login">
    ...
    <div style="margin:0; padding:20px; border-left:1px solid rgba(255,255,255,.5);">
    	<p class="tx-bold" style="margin-bottom:20px; line-height:1.25;">Masukkan ID dan password untuk mengelola layanan online Selfcare Anda</p>
        ...
        <p>
            <?=form_submit($login)?> &nbsp;|&nbsp; 
            <a href="<?=base_url()?>customer/forgetpwd" class="tx-yellow tx-bold">Lupa Password?</a>
        </p>
