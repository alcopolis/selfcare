...
<div id="modify-window">
	<p class="acknow">Daftar channel premium pilihan aktif dan yang dapat Anda modifikasi.</p>
    <div id="status-bar">
            ...
            <?php //if ($savelink!=''){ ?>
			    <form action="<?php echo $savelink; ?>" method="post">
                    ...
                    <a href="<?php echo $packagelink; ?>" id="cancel" class="btn">Cancel</a>
                    <input type="hidden" value="" id="chremain" name="chremain"/>
                	<input type="hidden" value="" id="editdata" name="editdata"/>
                </form>
             <?php // }?>
            </div>
        	<div id="pack-count" class="right">Remaining Channels <span id="ch-counter"></span></div>            
            <div class="clear"></div>
  	</div>
    <p id="notif"></p>
  	<div id="ch-content">
