	...
	<div class="wrapper">
		<div class="default-content">
			<div id="side" class="left">
				<div id="side-header">
                <div id="customer-id">Reset your password</div><br />
                <a href='<?=base_url()?>'><div id="customer-name">Back</div></a>
				</div>
				<div id="side-body">
					<div id="login">
					<?php 
						$form = array('name' => 'reset_form', 'id' => 'reset_form');
					...
					?>					
                    <p class="label">Your Customer Email:</p><?=form_input($email)?><br /><br />
                    <?=form_submit($submit)?>
                    <p class="label"><?=isset($msg) ? $msg : ''?></p>
                    <?=form_close()?>
					</div>
				</div>
			</div>
